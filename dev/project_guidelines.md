...
<ul>
  ...
  <li>1398/10/13: Final Report and Presentation section added.</li>
</ul>
<br>
</div>
...
**Note**: You can use [overleaf](https://www.overleaf.com) or any other latex editor.

**Download LaTeX Templates:**
- English: [[zip]({{ "/static_files/final_report_template_english.zip" | prepend: site.baseurl }})]
- Persian: [[zip]({{ "/static_files/final_report_template_persian.zip" | prepend: site.baseurl }})]
...
* Submit the package via [https://forms.gle/dfVN8LAQbt76C5HN9](https://forms.gle/dfVN8LAQbt76C5HN9)
...
- Then explain the applications; for example, one can ask a bot a question and the bot should look up all relevant web pages in search of an answer. Then, the answers should be represented in terms of a few meaningful sentences that may not have existed in those web pages.
